...
function GameCard(props) {
  ...
  return (
    <div className={`game-card ${mouseOver ? 'game-card--active' : ''}`} id={props.id}>
        <NavLink to={'/game/'+props.id} className="game-card__link"
        onMouseEnter={(e) => setValue(e.target, handleMouseOver)}
        onMouseLeave={(e) => setValue(e.target, handleMouseLeave)}
        ></NavLink>
        ...
        <div className="game-card__holder">
            ...
            <div className="game-card__inner">
                ...
                <div className="game-card__buttons">
                    ...
                    <button type='button' className={gameIsFavourite ? "game-card__button game-card__button--active" : "game-card__button"} onClick={(e) => FavouritesCtx.postFavourites(props.name, props.genre, props.image, props.id, props.video)}>
